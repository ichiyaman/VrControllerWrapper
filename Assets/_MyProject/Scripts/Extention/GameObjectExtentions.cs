...
public static class GameObjectExt
{
	...
	/// 位置を(0, 0, 0)にリセットします
	/// </summary>
	public static void ResetPos(this GameObject self)
	{
	...
	/// 位置を返します
	/// </summary>
	public static Vector3 GetPos(this GameObject self)
	{
	...
	/// Vector3 型で位置を設定します
	/// </summary>
	public static void SetPos(this GameObject self, Vector3 v)
	{
	...
	/// Vector2 型で位置を設定します
	/// </summary>
	public static void SetPos(this GameObject self, Vector2 v)
	{
		self.transform.position = new Vector3
		(
			v.x,
	...
	/// 位置を設定します
	/// </summary>
	public static void SetPos(this GameObject self, float x, float y)
	{
		self.transform.position = new Vector3
		(
			x,
	...
	/// 位置を設定します
	/// </summary>
	public static void SetPos(this GameObject self, float x, float y, float z)
	{
		self.transform.position = new Vector3
		(
			x,
	...
	/// Vector3 型で位置を加算します
	/// </summary>
	public static void AddPos(this GameObject self, Vector3 v)
	{
		self.transform.position += v;
	}
	...
	/// Vector2 型で位置を加算します
	/// </summary>
	public static void AddPos(this GameObject self, Vector2 v)
	{
		self.transform.position = new Vector3
		(
	...
	/// 位置を加算します
	/// </summary>
	public static void AddPos(this GameObject self, float x, float y)
	{
		self.transform.position = new Vector3
		(
			self.transform.position.x + x,
	...
	/// 位置を加算します
	/// </summary>
	public static void AddPos(this GameObject self, float x, float y, float z)
	{
		self.transform.position = new Vector3
		(
			self.transform.position.x + x,
	...
	/// </summary>
	public static void ResetLocalPos(this GameObject self)
	{
	...
	/// ローカル座標を返します
	/// </summary>
	public static Vector3 GetLocalPos(this GameObject self)
	{
	...
	/// </summary>
	public static void SetLocalPos(this GameObject self, Vector3 v)
	{
	...
	/// </summary>
	public static void SetLocalPos(this GameObject self, Vector2 v)
	{
		self.transform.localPosition = new Vector3
		(
			v.x,
	...
	/// ローカル座標を設定します
	/// </summary>
	public static void SetLocalPos(this GameObject self, float x, float y)
	{
		self.transform.localPosition = new Vector3
		(
			x,
	...
	/// ローカル座標を設定します
	/// </summary>
	public static void SetLocalPos(this GameObject self, float x, float y, float z)
	{
		self.transform.localPosition = new Vector3
		(
			x,
	...
	/// </summary>
	public static void AddLocalPos(this GameObject self, Vector3 v)
	{
		self.transform.localPosition += v;
	}
	...
	/// </summary>
	public static void AddLocalPos(this GameObject self, Vector2 v)
	{
		self.transform.localPosition = new Vector3
		(
	...
	/// ローカル座標を加算します
	/// </summary>
	public static void AddLocalPos(this GameObject self, float x, float y)
	{
		self.transform.localPosition = new Vector3
		(
			self.transform.localPosition.x + x,
	...
	/// ローカル座標を加算します
	/// </summary>
	public static void AddLocalPos(this GameObject self, float x, float y, float z)
	{
		self.transform.localPosition = new Vector3
		(
			self.transform.localPosition.x + x,
	...
	/// 回転角を(0, 0, 0)にリセットします
	/// </summary>
	public static void ResetEuler(this GameObject self)
	{
	...
	/// 回転角を返します
	/// </summary>
	public static Vector3 GetEuler(this GameObject self)
	{
	...
	/// 回転角を設定します
	/// </summary>
	public static void SetEuler(this GameObject self, Vector3 v)
	{
	...
	/// X 軸方向の回転角を加算します
	/// </summary>
	public static void AddEulerX(this GameObject self, float x)
	{
	...
	/// Y 軸方向の回転角を加算します
	/// </summary>
	public static void AddEulerY(this GameObject self, float y)
	{
	...
	/// Z 軸方向の回転角を加算します
	/// </summary>
	public static void AddEulerZ(this GameObject self, float z)
	{
	...
	/// </summary>
	public static void ResetLocalEuler(this GameObject self)
	{
	...
	/// ローカルの回転角を返します
	/// </summary>
	public static Vector3 GetLocalEuler(this GameObject self)
	{
	...
	/// </summary>
	public static float GetLocalEulerX(this GameObject self)
	{
	...
	/// </summary>
	public static float GetLocalEulerY(this GameObject self)
	{
	...
	/// </summary>
	public static float GetLocalEulerZ(this GameObject self)
	{
	...
	/// ローカルの回転角を設定します
	/// </summary>
	public static void SetLocalEuler(this GameObject self, Vector3 v)
	{
	...
	/// </summary>
	public static void SetLocalEulerX(this GameObject self, float x)
	{
	...
	/// </summary>
	public static void SetLocalEulerY(this GameObject self, float y)
	{
		self.transform.localEulerAngles = new Vector3
		(
	...
	/// </summary>
	public static void SetLocalEulerZ(this GameObject self, float z)
	{
		self.transform.localEulerAngles = new Vector3
		(
			self.transform.localEulerAngles.x,
	...
	/// </summary>
	public static void AddLocalEulerX(this GameObject self, float x)
	{
	...
	/// </summary>
	public static void AddLocalEulerY(this GameObject self, float y)
	{
	...
	/// ローカルの X 軸方向の回転角を加算します
	/// </summary>
	public static void AddLocalEulerZ(this GameObject self, float z)
	{
