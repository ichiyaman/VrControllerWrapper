...
public static class ComponentExtentions
{
	...
	/// 位置を(0, 0, 0)にリセットします
	/// </summary>
	public static void ResetPos( this Component self )
	{
	...
	/// 位置を返します
	/// </summary>
	public static Vector3 GetPos( this Component self )
	{
	...
	/// X 座標を返します
	/// </summary>
	public static float GetPosX( this Component self )
	{
	...
	/// Y 座標を返します
	/// </summary>
	public static float GetPosY( this Component self )
	{
	...
	/// Z 座標を返します
	/// </summary>
	public static float GetPosZ( this Component self )
	{
	...
	/// X 座標を設定します
	/// </summary>
	public static void SetPosX( this Component self, float x )
	{
	...
	/// Y 座標を設定します
	/// </summary>
	public static void SetPosY( this Component self, float y )
	{
		self.transform.position = new Vector3
		(
	...
	/// Z 座標を設定します
	/// </summary>
	public static void SetPosZ( this Component self, float z )
	{
		self.transform.position = new Vector3
		(
			self.transform.position.x,
	...
	/// Vector3 型で位置を設定します
	/// </summary>
	public static void SetPos( this Component self, Vector3 v )
	{
	...
	/// Vector2 型で位置を設定します
	/// </summary>
	public static void SetPos( this Component self, Vector2 v )
	{
		self.transform.position = new Vector3
		(
			v.x,
	...
	/// 位置を設定します
	/// </summary>
	public static void SetPos( this Component self, float x, float y )
	{
		self.transform.position = new Vector3
		(
			x,
	...
	/// 位置を設定します
	/// </summary>
	public static void SetPos( this Component self, float x, float y, float z )
	{
		self.transform.position = new Vector3
		(
			x,
	...
	/// X 座標に加算します
	/// </summary>
	public static void AddPosX( this Component self, float x )
	{
		self.transform.position = new Vector3
		(
	...
	/// Y 座標に加算します
	/// </summary>
	public static void AddPosY( this Component self, float y )
	{
		self.transform.position = new Vector3
		(
			self.transform.position.x,
	...
	/// Z 座標に加算します
	/// </summary>
	public static void AddPosZ( this Component self, float z )
	{
		self.transform.position = new Vector3
		(
			self.transform.position.x,
	...
	/// Vector3 型で位置を加算します
	/// </summary>
	public static void AddPos( this Component self, Vector3 v )
	{
		self.transform.position += v;
	}
	...
	/// Vector2 型で位置を加算します
	/// </summary>
	public static void AddPos( this Component self, Vector2 v )
	{
		self.transform.position = new Vector3
		(
	...
	/// 位置を加算します
	/// </summary>
	public static void AddPos( this Component self, float x, float y )
	{
		self.transform.position = new Vector3
		(
			self.transform.position.x + x,
	...
	/// 位置を加算します
	/// </summary>
	public static void AddPos( this Component self, float x, float y, float z )
	{
		self.transform.position = new Vector3
		(
			self.transform.position.x + x,
	...
	/// </summary>
	public static void ResetLocalPos( this Component self )
	{
	...
	/// ローカル座標を返します
	/// </summary>
	public static Vector3 GetLocalPos( this Component self )
	{
	...
	/// ローカル座標系の X 座標を返します
	/// </summary>
	public static float GetLocalPosX( this Component self )
	{
	...
	/// ローカル座標系の Y 座標を返します
	/// </summary>
	public static float GetLocalPosY( this Component self )
	{
	...
	/// ローカル座標系の Z 座標を返します
	/// </summary>
	public static float GetLocalPosZ( this Component self )
	{
	...
	/// ローカル座標系のX座標を設定します
	/// </summary>
	public static void SetLocalPosX( this Component self, float x )
	{
	...
	/// ローカル座標系のX座標を設定します
	/// </summary>
	public static void SetLocalPosXIfNotNull( this Component self, float x )
	{
		if ( self == null ) return;
		self.SetLocalPosX( x );
	}
	...
	/// ローカル座標系のY座標を設定します
	/// </summary>
	public static void SetLocalPosY( this Component self, float y )
	{
		self.transform.localPosition = new Vector3
		(
	...
	/// ローカル座標系のZ座標を設定します
	/// </summary>
	public static void SetLocalPosZ( this Component self, float z )
	{
		self.transform.localPosition = new Vector3
		(
			self.transform.localPosition.x,
	...
	/// </summary>
	public static void SetLocalPos( this Component self, Vector3 v )
	{
	...
	/// </summary>
	public static void SetLocalPos( this Component self, Vector2 v )
	{
		self.transform.localPosition = new Vector3
		(
			v.x,
	...
	/// ローカル座標を設定します
	/// </summary>
	public static void SetLocalPos( this Component self, float x, float y )
	{
		self.transform.localPosition = new Vector3
		(
			x,
	...
	/// ローカル座標を設定します
	/// </summary>
	public static void SetLocalPos( this Component self, float x, float y, float z )
	{
		self.transform.localPosition = new Vector3
		(
			x,
	...
	/// ローカルのX座標に加算します
	/// </summary>
	public static void AddLocalPosX( this Component self, float x )
	{
		self.transform.localPosition = new Vector3
		(
	...
	/// ローカルのY座標に加算します
	/// </summary>
	public static void AddLocalPosY( this Component self, float y )
	{
		self.transform.localPosition = new Vector3
		(
			self.transform.localPosition.x,
	...
	/// ローカルのZ座標に加算します
	/// </summary>
	public static void AddLocalPosZ( this Component self, float z )
	{
		self.transform.localPosition = new Vector3
		(
			self.transform.localPosition.x,
	...
	/// </summary>
	public static void AddLocalPos( this Component self, Vector3 v )
	{
		self.transform.localPosition += v;
	}
	...
	/// </summary>
	public static void AddLocalPos( this Component self, Vector2 v )
	{
		self.transform.localPosition = new Vector3
		(
	...
	/// ローカル座標を加算します
	/// </summary>
	public static void AddLocalPos( this Component self, float x, float y )
	{
		self.transform.localPosition = new Vector3
		(
			self.transform.localPosition.x + x,
	...
	/// ローカル座標を加算します
	/// </summary>
	public static void AddLocalPos( this Component self, float x, float y, float z )
	{
		self.transform.localPosition = new Vector3
		(
			self.transform.localPosition.x + x,
	...
	/// 回転角を(0, 0, 0)にリセットします
	/// </summary>
	public static void ResetEulers( this Component self )
	{
	...
	/// 回転角を返します
	/// </summary>
	public static Vector3 GetEulers( this Component self )
	{
	...
	/// X 軸方向の回転角を返します
	/// </summary>
	public static float GetEulerX( this Component self )
	{
	...
	/// Y 軸方向の回転角を返します
	/// </summary>
	public static float GetEulerY( this Component self )
	{
	...
	/// Z 軸方向の回転角を返します
	/// </summary>
	public static float GetEulerZ( this Component self )
	{
	...
	/// 回転角を設定します
	/// </summary>
	public static void SetEulers( this Component self, Vector3 v )
	{
	...
	/// X 軸方向の回転角を設定します
	/// </summary>
	public static void SetEulerX( this Component self, float x )
	{
	...
	/// Y 軸方向の回転角を設定します
	/// </summary>
	public static void SetEulerY( this Component self, float y )
	{
		self.transform.eulerAngles = new Vector3
		(
	...
	/// Z 軸方向の回転角を設定します
	/// </summary>
	public static void SetEulerZ( this Component self, float z )
	{
		self.transform.eulerAngles = new Vector3
		(
			self.transform.eulerAngles.x,
	...
	/// X 軸方向の回転角を加算します
	/// </summary>
	public static void AddEulerX( this Component self, float x )
	{
	...
	/// Y 軸方向の回転角を加算します
	/// </summary>
	public static void AddEulerY( this Component self, float y )
	{
	...
	/// Z 軸方向の回転角を加算します
	/// </summary>
	public static void AddEulerZ( this Component self, float z )
	{
	...
	/// </summary>
	public static void ResetLocalEulers( this Component self )
	{
	...
	/// ローカルの回転角を返します
	/// </summary>
	public static Vector3 GetLocalEulers( this Component self )
	{
	...
	/// </summary>
	public static float GetLocalEulerX( this Component self )
	{
	...
	/// </summary>
	public static float GetLocalEulerY( this Component self )
	{
	...
	/// </summary>
	public static float GetLocalEulerZ( this Component self )
	{
	...
	/// ローカルの回転角を設定します
	/// </summary>
	public static void SetLocalEulers( this Component self, Vector3 v )
	{
	...
	/// </summary>
	public static void SetLocalEulerX( this Component self, float x )
	{
	...
	/// </summary>
	public static void SetLocalEulerY( this Component self, float y )
	{
		self.transform.localEulerAngles = new Vector3
		(
	...
	/// </summary>
	public static void SetLocalEulerZ( this Component self, float z )
	{
		self.transform.localEulerAngles = new Vector3
		(
			self.transform.localEulerAngles.x,
	...
	/// </summary>
	public static void AddLocalEulerX( this Component self, float x )
	{
	...
	/// </summary>
	public static void AddLocalEulerY( this Component self, float y )
	{
	...
	/// ローカルの X 軸方向の回転角を加算します
	/// </summary>
	public static void AddLocalEulerZ( this Component self, float z )
	{
	...
	/// 親オブジェクトを設定します
	/// </summary>
	public static void SetParent( this Component self, Component parent, bool worldPosStays )
	{
		self.transform.SetParent( parent != null ? parent.transform : null, worldPosStays );
	}
	...
	/// 親オブジェクトを設定します
	/// </summary>
	public static void SetParent( this Component self, GameObject parent, bool worldPosStays )
	{
		self.transform.SetParent( parent != null ? parent.transform : null, worldPosStays );
	}
	...
	/// 向きを変更します
	/// </summary>
	public static void LookAt( this Component self, Vector3 worldPos )
	{
		self.transform.LookAt( worldPos );
	}
	...
	/// 向きを変更します
	/// </summary>
	public static void LookAt( this Component self, Vector3 worldPos, Vector3 worldUp )
	{
		self.transform.LookAt( worldPos, worldUp );
	}
	...
	/// グローバル座標を返します
	/// </summary>
	public static Vector3 GetGlobalPos( this Component self )
	{
	...
	/// ローカル座標系の位置を四捨五入します
	/// </summary>
	public static void RoundLocalPos( this Component self )
	{
	...
	/// ローカル座標系の回転角を四捨五入します
	/// </summary>
	public static void RoundLocalEulers( this Component self )
	{
